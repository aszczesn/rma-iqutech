...
class Auth extends MX_Controller {
    ...
    function change_password()
    {
        ...
        if ($this->form_validation->run() == false)
        {
            ...
            $data['min_password_length'] = $this->config->item(
                    'min_password_length', 'ion_auth'
            );
    ...
    function forgot_password()
    {
        ...
        if($this->config->item('identity', 'ion_auth') == 'username' )
        {
            $this->form_validation->set_rules(
                'email', 
                $this->lang->line(
                    'forgot_password_username_identity_label'
                ), 
                'required'
            );
        }
        ...
        if ($this->form_validation->run() == false)
        {
            ...
            if ( $this->config->item('identity', 'ion_auth') == 'username' ){
                $data['identity_label'] = $this->lang->line(
                        'forgot_password_username_identity_label');
            }
            else
            {
        ...
        else
        {
            ...
            if(empty($identity)) {
                ...
                if($this->config->item('identity', 'ion_auth') == 'username')
                {
                    $this->ion_auth->set_message(
                           'forgot_password_username_not_found'
                    );
                }
                else
                {
    ...
    function _render_page($view, $data=null, $render=false)
    {
        ...
        return Modules::run('template/operator_two_col', $data);
