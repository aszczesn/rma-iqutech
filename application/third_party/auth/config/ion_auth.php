...
|
*/
$config['collections']['users']          = 'sys_users';
$config['collections']['groups']         = 'sys_groups';
$config['collections']['login_attempts'] = 'sys_login_attempts';
/*
| -------------------------------------------------------------------------
| Tables.
| -------------------------------------------------------------------------
 ...
 */
$config['site_title']                 = "rma.iqutech.com";       // Site Title, example.com
$config['admin_email']                = "albert.szczesny@yahoo.com"; // Admin Email, admin@example.com
